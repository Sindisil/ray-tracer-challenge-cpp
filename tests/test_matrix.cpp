...
TEST_CASE("Matrix equality with identical matrices") {
  auto a = Mat4{{1.0f, 2.0f, 3.0f, 4.0f},
                {5.0f, 6.0f, 7.0f, 8.0f},
                {9.0f, 8.0f, 7.0f, 6.0f},
                {5.0f, 4.0f, 3.0f, 2.0f}};
  auto b = Mat4{{1.0f, 2.0f, 3.0f, 4.0f},
                {5.0f, 6.0f, 7.0f, 8.0f},
                {9.0f, 8.0f, 7.0f, 6.0f},
                {5.0f, 4.0f, 3.0f, 2.0f}};
  CHECK(a == b);
...
TEST_CASE("Calculating the inverse of a matrix") {
  ...
  CHECK(b == Mat4{{0.21805f, 0.45113f, 0.24060f, -0.04511f},
...
TEST_CASE("Calculating the inverse of another matrix") {
  ...
  CHECK(a.invert() == Mat4{{-.15385f, -.15385f, -.28205f, -.53846f},
